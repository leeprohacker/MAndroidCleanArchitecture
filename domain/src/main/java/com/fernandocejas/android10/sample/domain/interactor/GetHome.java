 ...
 */
public class GetHome extends UseCase<IHome, Void> {

  private final DRepository userRepository;

  @Inject
  GetHome(DRepository userRepository, ThreadExecutor threadExecutor,
          PostExecutionThread postExecutionThread) {
    super(threadExecutor, postExecutionThread);
    this.userRepository = userRepository;
  }

  @Override Observable<IHome> buildUseCaseObservable(Void unused) {
